...
int main(){
    PatternBuilder::Cook cook;
    PatternBuilder::HawaiianPizzaBuilder hawaiianPizzaBuilder;
    PatternBuilder::SpicyPizzaBuilder    spicyPizzaBuilder;
